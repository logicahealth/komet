...
public class PathEConcept extends AbstractMojo {
    ...
    private static void createPathEConcepts(PathSpec[] initialPaths, File out) throws IOException {
        ...
        for (PathSpec spec : initialPaths) {
            ...
            pathMember.componentUuid = pathMember.primordialUuid;
            ...
            pathMember.setRefexExtensionUuid(TermAux.PATH_REFSET.getUuids()[0]);
            ...
            originMember.componentUuid = originMember.primordialUuid;
            ...
            originMember.setRefexExtensionUuid(TermAux.PATH_ORIGIN_REFSET.getUuids()[0]);
