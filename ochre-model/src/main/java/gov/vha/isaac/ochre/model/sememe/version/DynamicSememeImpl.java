 ...
 * @author kec
 */
public class DynamicSememeImpl<T extends DynamicSememeImpl<T>> extends SememeVersionImpl<T> implements MutableDynamicSememe<T> {

    public DynamicSememeImpl(SememeChronologyImpl<T> container, 
