...
public class LiteralNodeString extends LiteralNode {
    ...
    public LiteralNodeString(LogicExpressionOchreImpl logicGraphVersion, DataInputStream dataInputStream) throws IOException {
    ...
    public LiteralNodeString(LogicExpressionOchreImpl logicGraphVersion, String literalValue) {
