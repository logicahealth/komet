...
public class DisjointWithNode extends ConnectorNode {
    ...
    public DisjointWithNode(LogicExpressionOchreImpl logicGraphVersion, DataInputStream dataInputStream) throws IOException {
        super(logicGraphVersion, dataInputStream);
    }

    public DisjointWithNode(LogicExpressionOchreImpl logicGraphVersion, AbstractNode... children) {
