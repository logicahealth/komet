...
public final class RoleNodeSomeWithNids extends TypedNodeWithNids {
    ...
    public RoleNodeSomeWithNids(LogicExpressionOchreImpl logicGraphVersion, DataInputStream dataInputStream) throws IOException {
        super(logicGraphVersion, dataInputStream);
    }

    public RoleNodeSomeWithNids(LogicExpressionOchreImpl logicGraphVersion, int typeConceptNid, AbstractNode child) {
