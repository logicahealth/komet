 ...
 *
 * In the new DynanamicSemanticAPI - there are strict requirements on the structure of the
 * assemblage concept.
 * <br>
 * <br>
 ...
 *       {@link DynamicColumnInfo#createNewDynamicSemanticColumnInfoConcept(String, String, org.ihtsdo.otf.tcc.api.coordinate.EditCoordinate, org.ihtsdo.otf.tcc.api.coordinate.ViewCoordinate)}
 * <li>A string column which can be parsed as a member of the {@link DynamicSemanticDataType} class, which represents
 ...
 * <li>An (optional) array column which contains strings which can be parsed as a member of the {@link DynamicSemanticValidatorType} class, which represents
 ...
 * itself has a semantic extension of type {@link DynamicConstants#DYNAMIC_SEMANTIC_DEFINITION_DESCRIPTION} - the value of
 * this description should explain the the overall purpose of this Semantic.
 * <br>
 * <br>
 * The assemblage concept may also contain a single {@link DynamicSemanticVersion} annotation of type
 ...
 * See {@link sh.isaac.impl.semantic.DynamicSemanticUtility#createNewDynamicSemanticUsageDescriptionConcept}
 *
 * @author <a href="mailto:daniel.armbrust.list@gmail.com">Dan Armbrust</a>
 */
public interface DynamicUsageDescription {
   /**
    * The ordered column information which will correspond with the data returned by {@link DynamicSemanticChronicle#getData()}
