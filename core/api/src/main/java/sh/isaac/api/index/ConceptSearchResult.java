...
public class ConceptSearchResult implements SearchResult {
	...
	private ConceptSearchResult(StampCoordinate coordForSort)
	{
	 ...
	 * @param componentNid the component nid
	 * @param score the score
	 * @param stampForNidRanking used to sort nids when the scores tie (prefer active over inactive)
	 */
	public ConceptSearchResult(int conceptNid, int componentNid, float score, StampCoordinate stampForNidRanking) {
		this(stampForNidRanking);
