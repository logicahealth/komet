 ...
 *
 * Any class which implements this interface will get the notifications below, when
 * index events happen, if they register with the indexer(s).
 *
...
public interface IndexStatusListener
{
	...
	/**
	 * An identifier for this implementation of an IndexStatusListener
	 * @return the id
	 */
