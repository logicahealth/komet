 ...
 * @author kec
 */
public class ConceptSpecificationAdaptor extends XmlAdapter<ConceptProxy, ConceptSpecification> {

    @Override
    public ConceptSpecification unmarshal(ConceptProxy proxy) throws Exception {
        return proxy;
    }
