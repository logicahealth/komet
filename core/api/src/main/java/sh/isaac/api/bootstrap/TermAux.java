...
public class TermAux implements IsaacCache {
    ...
    /**
     * ConceptProxy for: "Path origin assemblage". IsaacMetadataAuxiliary has
     * "path origins assemblage", TermAux has "Path origin reference set"
     */
    ...
    /**
     * ConceptProxy for: "path assemblage". IsaacMetadataAuxiliary has "paths
     * assemblage", TermAux has "paths"
     */
    ...
    /**
     * ConceptProxy for: "SNOMED integer identifier. 'SNOMED CT integer
     * identifier' - 900000000000294009; 'SNOMED integer id'
     */
    ...
    /**
     * ConceptProxy for: "Definition description type". IsaacMetadataAuxiliary
     * has "definition description type", TermAux has "Definition"
     */
    ...
    /**
     * ConceptProxy for: "Description type in source terminology". Needed within
     * DynamicMetadata constants, which can't reference IsaacMetadataAuxiliary
     */
    ...
    /**
     * ConceptProxy for: "US dialect assemblage". IsaacMetadataAuxiliary has "US
     * English dialect", TermAux has "United States of America English language
     * reference set"
     */
    ...
    /**
     * ConceptProxy for: "Great Britain dialect assemblage".
     * IsaacMetadataAuxiliary has "GB English dialect", TermAux has "Great
     * Britain English language reference set"
     */
    ...
    /**
     * ConceptProxy for: "description not case sensitive". SCT ID:
     * 900000000000448009
     */
    ...
    /**
     * ConceptProxy for: "description initial character sensitive". SCT ID:
     * 900000000000020002
     */
    ...
    /**
     * ConceptProxy for: "EL++ logic profile". IsaacMetadataAuxiliary has "EL++
     * profile", TermAux has "EL++ logic profile"
     */
    ...
    /**
     * ConceptProxy for: "Snorocket classifier". IsaacMetadataAuxiliary has
     * "SnoRocket classifier", TermAux has "Snorocket classifier"
     */
    ...
    /**
     * ConceptProxy for: "sufficient concept definition". SCTID:
     * 900000000000073002
     */
    ...
    /**
     * ConceptProxy for: "necessary but not sufficient concept definition".
     * SCTID: 900000000000074008
     */
    ...
    public static ConceptSpecification SPEC9 = new ConceptProxy("", "", UUID.fromString("eada0aea-a14c-549d-89c8-9aa48aa6d184"));
    public static ConceptSpecification SPEC10 = new ConceptProxy("", "", UUID.fromString("bb34ccb6-857d-5cbd-8114-8c34a14b1e42"));
    public static ConceptSpecification SPEC11 = new ConceptProxy("", "", UUID.fromString("e6ec4948-9167-5c16-9698-ab2747e5cdf3"));
    public static ConceptSpecification SPEC12 = new ConceptProxy("", "", UUID.fromString("38baca53-e626-5196-91a5-76e05cb3e115"));
