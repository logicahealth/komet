...
public class TermAux implements StaticIsaacCache {
   ...
   public static ConceptProxy SOLOR_METADATA = new ConceptProxy("Metadata", UUID.fromString("7bbd4210-381c-11e7-9598-0800200c9a66"));
   ...
   public static ConceptProxy SUBSTANCE = new ConceptProxy("Substance", "Substance", UUID.fromString("95f41098-8391-3f5e-9d61-4b019f1de99d"));
    ...
    public static ConceptProxy DISCREATE_MEASURE_SEMANTICS = new ConceptProxy("Discrete measure semantic", "Item measurement", UUID.fromString("2bd0936f-62dd-5425-bc38-1eca8abb8242"));
   ...
   public static ConceptProxy STAMP_SEQUENCE_FOR_VERSION = new ConceptProxy("Stamp sequence for version", "Stamp sequence for version", UUID.fromString("0b026997-e0c6-59b1-871f-8486710f7ac1"));
...
public static ConceptProxy SPEC9 = new ConceptProxy("", "", UUID.fromString("040e9fe1-b3f3-5721-b970-66b16f8faf07"));
public static ConceptProxy SPEC10 = new ConceptProxy("", "", UUID.fromString("b792685d-a3d0-519a-9316-1cf388c5f96b"));
public static ConceptProxy SPEC11 = new ConceptProxy("", "", UUID.fromString("3e559afb-69e5-5b44-9c59-8c9076ecca2e"));
public static ConceptProxy SPEC12 = new ConceptProxy("", "", UUID.fromString("b6488476-1bdf-5986-966d-ed406b40e958"));
public static ConceptProxy SPEC13 = new ConceptProxy("", "", UUID.fromString("d03c92c7-e630-59da-8680-74b1be6497ce"));
public static ConceptProxy SPEC14 = new ConceptProxy("", "", UUID.fromString("52ec2f3a-588d-502d-aa72-b59841b2fe31"));
public static ConceptProxy SPEC15 = new ConceptProxy("", "", UUID.fromString("16be5d9b-0d0f-5573-8dca-8a21257688d2"));
public static ConceptProxy SPEC16 = new ConceptProxy("", "", UUID.fromString("8cff3e39-0cdf-55d5-8986-d701ee828072"));
public static ConceptProxy SPEC17 = new ConceptProxy("", "", UUID.fromString("3090e1ec-564d-5d27-8f05-ecb0df60e29c"));
public static ConceptProxy SPEC18 = new ConceptProxy("", "", UUID.fromString("95ea46f2-c6f8-5ee2-a585-175f63b984cb"));
public static ConceptProxy SPEC19 = new ConceptProxy("", "", UUID.fromString("f3fed8b4-e801-5dbd-8983-7fd1a43fb69d"));
public static ConceptProxy SPEC20 = new ConceptProxy("", "", UUID.fromString("c6963a54-2931-5e4c-8e1e-62c31415e01e"));
public static ConceptProxy SPEC21 = new ConceptProxy("", "", UUID.fromString("9f9911bd-0c84-5d4f-88e1-06bd9008dbd4"));
public static ConceptProxy SPEC22 = new ConceptProxy("", "", UUID.fromString("456392ae-04de-5bf2-be48-691e62f7c0fd"));
public static ConceptProxy SPEC23 = new ConceptProxy("", "", UUID.fromString("fb111a91-4de1-5efb-80f2-2d5e8d45777d"));
public static ConceptProxy SPEC24 = new ConceptProxy("", "", UUID.fromString("a0467747-f7de-5d1f-8fae-b2d6e2a655a5"));
public static ConceptProxy SPEC25 = new ConceptProxy("", "", UUID.fromString("9be8fae9-4456-5e3d-a61e-b34112055a91"));
public static ConceptProxy SPEC26 = new ConceptProxy("", "", UUID.fromString("887e0403-268c-5244-b922-1868b5b912f1"));
public static ConceptProxy SPEC27 = new ConceptProxy("", "", UUID.fromString("18e908fe-c0e5-575b-9a53-3b7238edaed2"));
public static ConceptProxy SPEC28 = new ConceptProxy("", "", UUID.fromString("0cd7383f-98d3-5619-9975-552a9deea2bc"));
public static ConceptProxy SPEC29 = new ConceptProxy("", "", UUID.fromString("46071c3c-100b-5197-aefb-ece631789d21"));
public static ConceptProxy SPEC30 = new ConceptProxy("", "", UUID.fromString("95327a6b-007d-5816-9c98-c83a9cb8007f"));
public static ConceptProxy SPEC31 = new ConceptProxy("", "", UUID.fromString("66a017eb-8c64-551e-b25b-b076ee6d8046"));
public static ConceptProxy SPEC32 = new ConceptProxy("", "", UUID.fromString("95239d63-3c4b-5a05-8adb-d1ded3de40ac"));
public static ConceptProxy SPEC33 = new ConceptProxy("", "", UUID.fromString("d57e1170-73c6-5de6-b7d3-ad3fe1590f19"));
public static ConceptProxy SPEC34 = new ConceptProxy("", "", UUID.fromString("9200bbe0-7c6a-50b7-a75e-1d477de489c9"));
public static ConceptProxy SPEC35 = new ConceptProxy("", "", UUID.fromString("f9ab5eef-ead4-5132-b0a2-52dd4ecacc53"));
public static ConceptProxy SPEC36 = new ConceptProxy("", "", UUID.fromString("7cb0edda-3e50-52f4-af62-66ed7811d057"));
public static ConceptProxy SPEC37 = new ConceptProxy("", "", UUID.fromString("1d64f8af-bb12-5955-8105-c8dad5220dfd"));
public static ConceptProxy SPEC38 = new ConceptProxy("", "", UUID.fromString("3d702457-7200-5f10-8a38-57e979d9f4a9"));
public static ConceptProxy SPEC39 = new ConceptProxy("", "", UUID.fromString("c9cf2730-5a81-52f4-a6bb-60513c2972f1"));
public static ConceptProxy SPEC40 = new ConceptProxy("", "", UUID.fromString("12a5a81c-d949-53c2-a4db-a8e2ee183f16"));
public static ConceptProxy SPEC41 = new ConceptProxy("", "", UUID.fromString("dbfceab8-d1be-5dea-890c-698012b29ba2"));
public static ConceptProxy SPEC42 = new ConceptProxy("", "", UUID.fromString("5f07ae06-f474-5fee-a0a5-edad41e980fc"));
public static ConceptProxy SPEC43 = new ConceptProxy("", "", UUID.fromString("3bbaaf8b-899e-5971-8065-5720440a9b07"));
public static ConceptProxy SPEC44 = new ConceptProxy("", "", UUID.fromString("6cdd0e52-782b-5e42-b180-6234b304f3fd"));
public static ConceptProxy SPEC45 = new ConceptProxy("", "", UUID.fromString("92107c7c-80de-566f-b4b7-aa159c413006"));
public static ConceptProxy SPEC46 = new ConceptProxy("", "", UUID.fromString("e8cfef22-9ce6-5039-899d-c29a6842e450"));
public static ConceptProxy SPEC47 = new ConceptProxy("", "", UUID.fromString("04d83ec4-b6d3-5304-9167-2883df5957c1"));
public static ConceptProxy SPEC48 = new ConceptProxy("", "", UUID.fromString("e6876586-5d31-580f-931b-14c4df338342"));
public static ConceptProxy SPEC49 = new ConceptProxy("", "", UUID.fromString("6e081cef-f212-5859-98e6-f1e3c684968e"));
public static ConceptProxy SPEC50 = new ConceptProxy("", "", UUID.fromString("46705f56-c531-5691-a0d4-c42316716281"));
public static ConceptProxy SPEC51 = new ConceptProxy("", "", UUID.fromString("e641f623-7f64-5a83-a133-8954276a0116"));
public static ConceptProxy SPEC52 = new ConceptProxy("", "", UUID.fromString("70937df5-5b5d-559c-9842-29d166d1991b"));
public static ConceptProxy SPEC53 = new ConceptProxy("", "", UUID.fromString("6a059ba0-5b24-5f73-9f8e-178ecceeed42"));
public static ConceptProxy SPEC54 = new ConceptProxy("", "", UUID.fromString("6c758d65-768f-505d-b016-c54a3f51ecd6"));
public static ConceptProxy SPEC55 = new ConceptProxy("", "", UUID.fromString("648c2cb6-7621-5235-aa95-2d5ca2845393"));
public static ConceptProxy SPEC56 = new ConceptProxy("", "", UUID.fromString("c6e97a10-83d9-5330-8735-e0d67f43b1b0"));
public static ConceptProxy SPEC57 = new ConceptProxy("", "", UUID.fromString("a5478ee9-030f-50f9-a57c-ab48357e7d4b"));
public static ConceptProxy SPEC58 = new ConceptProxy("", "", UUID.fromString("01e4c4de-2546-5675-9a57-d5af828cbf44"));
public static ConceptProxy SPEC59 = new ConceptProxy("", "", UUID.fromString("9e6291e2-769b-5799-9a29-5a3be3bb5be6"));
public static ConceptProxy SPEC60 = new ConceptProxy("", "", UUID.fromString("346aca2f-9cc4-5b80-97f7-3e0fc9cc448a"));
public static ConceptProxy SPEC61 = new ConceptProxy("", "", UUID.fromString("4abfe63b-edee-5e6e-9bd3-60bd861d5068"));
public static ConceptProxy SPEC62 = new ConceptProxy("", "", UUID.fromString("e4d677e0-3c9f-50dd-bf05-ee5130e0ce70"));
public static ConceptProxy SPEC63 = new ConceptProxy("", "", UUID.fromString("38eb9cb8-0293-5a2d-a0d2-b467e63741e8"));
public static ConceptProxy SPEC64 = new ConceptProxy("", "", UUID.fromString("735f7d02-b242-50a6-8b48-5846f559da3f"));
public static ConceptProxy SPEC65 = new ConceptProxy("", "", UUID.fromString("c1a7660b-7b3c-53fb-a2de-5c47363b41c6"));
public static ConceptProxy SPEC66 = new ConceptProxy("", "", UUID.fromString("d96754a3-2097-5bc4-b4aa-f75441897903"));
public static ConceptProxy SPEC67 = new ConceptProxy("", "", UUID.fromString("58ea4ce5-15bf-56a3-8c0b-455f930cca31"));
public static ConceptProxy SPEC68 = new ConceptProxy("", "", UUID.fromString("7434d81b-da3a-5661-84d8-818612aac0b2"));
public static ConceptProxy SPEC69 = new ConceptProxy("", "", UUID.fromString("7c2f2ec4-4870-50af-8e42-56ef4909c8ae"));
public static ConceptProxy SPEC70 = new ConceptProxy("", "", UUID.fromString("757db1e1-20b5-5aca-beed-e686ecfcd59f"));
public static ConceptProxy SPEC71 = new ConceptProxy("", "", UUID.fromString("b84209f8-9815-5446-bd9a-9ae8118e1481"));
public static ConceptProxy SPEC72 = new ConceptProxy("", "", UUID.fromString("55ea945d-1ae1-5206-8c57-0c44dfeeb4fd"));
public static ConceptProxy SPEC73 = new ConceptProxy("", "", UUID.fromString("6070de71-58e7-5af6-9fee-927d006df919"));
public static ConceptProxy SPEC74 = new ConceptProxy("", "", UUID.fromString("6f8d21b9-bf66-56f0-9c36-fa76273a7b33"));
public static ConceptProxy SPEC75 = new ConceptProxy("", "", UUID.fromString("e25ff745-b915-5f17-90f0-57c7ce971d67"));
public static ConceptProxy SPEC76 = new ConceptProxy("", "", UUID.fromString("805f541d-a8a9-5d91-b428-340b8b0bc49c"));
public static ConceptProxy SPEC77 = new ConceptProxy("", "", UUID.fromString("3b1d54dd-22ce-5d90-b0c5-4874ba2171a0"));
public static ConceptProxy SPEC78 = new ConceptProxy("", "", UUID.fromString("85ded6f8-4734-516b-b420-49d74776c550"));
public static ConceptProxy SPEC79 = new ConceptProxy("", "", UUID.fromString("73cbfe26-b54a-515d-ba4a-64d5066d9bac"));
public static ConceptProxy SPEC80 = new ConceptProxy("", "", UUID.fromString("3995e48f-c77c-5b04-88d9-549dffae95f8"));
public static ConceptProxy SPEC81 = new ConceptProxy("", "", UUID.fromString("4211cf36-bd75-586a-805c-51f059e2eaaa"));
public static ConceptProxy SPEC82 = new ConceptProxy("", "", UUID.fromString("ee04d7db-3407-568f-9b93-7b1f9f5bb0fc"));
public static ConceptProxy SPEC83 = new ConceptProxy("", "", UUID.fromString("c93829b2-aa78-5a84-ac9a-c34307844166"));
public static ConceptProxy SPEC84 = new ConceptProxy("", "", UUID.fromString("c5daf0e9-30dc-5b3e-a521-d6e6e72c8a95"));
public static ConceptProxy SPEC85 = new ConceptProxy("", "", UUID.fromString("715bd36d-6090-5b37-8ae7-88c9e532010e"));
public static ConceptProxy SPEC86 = new ConceptProxy("", "", UUID.fromString("80710ea6-983c-5fa0-8908-e479f1f03ea9"));
public static ConceptProxy SPEC87 = new ConceptProxy("", "", UUID.fromString("e95b6718-f824-5540-817b-8e79544eb97a"));
public static ConceptProxy SPEC88 = new ConceptProxy("", "", UUID.fromString("676a8e10-f75a-5574-a493-3a95aef6ec35"));
public static ConceptProxy SPEC89 = new ConceptProxy("", "", UUID.fromString("529a7069-bd33-59e6-b2ce-537fa874360a"));
public static ConceptProxy SPEC90 = new ConceptProxy("", "", UUID.fromString("208bf7a8-c084-5476-8ac4-ebadb5a2ab65"));
