...
public class TermAux {
   ...
   public static ConceptSpecification ASSOCIATED_PARAMETER_QUERY_CLAUSE = new ConceptProxy("Associated parameter (query clause)", " ↳ ", UUID.fromString("bb6a49c0-72fa-4ba9-9954-098c4473b255"));
