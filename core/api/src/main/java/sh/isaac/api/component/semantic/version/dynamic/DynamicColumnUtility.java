...
/**
 * The Interface DynamicColumnUtility.
 */
@Contract
public interface DynamicColumnUtility {
   /**
    * A convenience method to read the values that should be used as the name and description for a data
    * column in a dynamic from an existing concept.
    *
    * @param columnDescriptionConcept the column description concept
    * @return an array of two strings, first entry name, second entry description
    */
