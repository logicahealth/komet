 ...
 * @author kec
 */
public class TaxonomyLinkage implements TaxonomyLink {
    final int typeNid;
    final int destinationNid;

    public TaxonomyLinkage(int typeNid, int destinationNid) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TaxonomyLink)) {
            return false;
        }
        final TaxonomyLink other = (TaxonomyLink) obj;
