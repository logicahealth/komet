...
public class PasswordHasher {
    ...
    * one generated by {@link #getSaltedHash(String)}
    *
   ...
   /**
    * Decrypts data encrypted with the {@link #encrypt(String, byte[], byte[])} where the user provided their own salt.
    * 
    ...
    * @throws Exception
    */
   public static byte[] decrypt(String password, byte[] salt, String data)
            throws Exception {
   ...
   /**
    * Calls {@link #encrypt(String, byte[])}
    * @param password
    * @param data
    * @return
    * @throws Exception
  ...
  /**
    ...
    * 
    * See {@link #check(String, String)} for a mechanism to validate a hash generated in this way.
    * 
