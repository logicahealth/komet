...
public class Observable_Nid1_Nid2_VersionImpl
   ...
   @Override
    ...
    public <V extends Version> V makeAnalog(Transaction transaction, int authorNid) {
        Nid1_Nid2_VersionImpl newVersion = this.stampedVersionProperty.get().makeAnalog(transaction, authorNid);
        return setupAnalog(newVersion);
    }

    private <V extends Version> V setupAnalog(Nid1_Nid2_VersionImpl newVersion) {
