...
public class LiteralNodeInteger
    ...
    */
   public LiteralNodeInteger(LogicalExpressionImpl logicGraphVersion,
                             ByteArrayDataBuffer dataInputStream) {
      super(logicGraphVersion, dataInputStream);
      this.literalValue = dataInputStream.getInt();
   }
    ...
    */
   public LiteralNodeInteger(LogicalExpressionImpl logicGraphVersion, int literalValue) {
   ...
   protected void writeNodeData(ByteArrayDataBuffer dataOutput, DataTarget dataTarget) {
      ...
      dataOutput.putInt(this.literalValue);
   }
