...
public class HashTreeWithIntArraySetsIsolated
        implements Tree {
...
//   }
    ...
    public final Tree createAncestorTree(int childNid) {
        final HashTreeWithIntArraySetsIsolated tree = new HashTreeWithIntArraySetsIsolated(this);
     ...
     */
    private void addParentsAsChildren(HashTreeWithIntArraySetsIsolated tree, int childNid, int[] parentNids) {
    ...
    private List<HashTreeWithIntArraySetsIsolated.Solution> getMinimalCommonAncestorSolutions(int nid1, int nid2) {
        Instant startInstant = Instant.now();
        boolean debugDistance = false;
        ...
        SortedSet<HashTreeWithIntArraySetsIsolated.DistanceRecord> nid2DistanceRecords = new TreeSet<>();
        commonAncestors.forEachKey(element -> {
            ...
            for (int[] ancestorNidArray:  nid1AncestorNidArrays) {
                for (int distance = 1; distance < ancestorNidArray.length; distance++) {
                    if (ancestorNidArray[distance] == element) {
                        nid1DistanceRecords.add(new HashTreeWithIntArraySetsIsolated.DistanceRecord(nid1, element, distance));
                        break;
                    }
                }
            }
            ...
            for (int[] ancestorNidArray:  nid2AncestorNidArrays) {
                for (int distance = 1; distance < ancestorNidArray.length; distance++) {
                    if (ancestorNidArray[distance] == element) {
                        nid2DistanceRecords.add(new HashTreeWithIntArraySetsIsolated.DistanceRecord(nid2, element, distance));
                        break;
                    }
                }
            }
        ...
        SortedSet<HashTreeWithIntArraySetsIsolated.Solution> possibleBestSolutions = new TreeSet<>();
        for (HashTreeWithIntArraySetsIsolated.DistanceRecord nid1DistanceRecord: nid1DistanceRecords) {
            if (currentBestSolution != null && currentBestSolution.taxonomyDistance < nid1DistanceRecord.distance) {
                break;
            }
            for (HashTreeWithIntArraySetsIsolated.DistanceRecord nid2DistanceRecord: nid2DistanceRecords) {
                ...
                if (nid1DistanceRecord.isSolution(nid2DistanceRecord)) {
                    if (currentBestSolution == null) {
                        currentBestSolution = new HashTreeWithIntArraySetsIsolated.Solution(nid1DistanceRecord, nid2DistanceRecord);
        ...
        for (HashTreeWithIntArraySetsIsolated.Solution solution: possibleBestSolutions) {
    ...
    public int[] getLowestCommonAncestor(int nid1, int nid2) {
        ...
        List<HashTreeWithIntArraySetsIsolated.Solution> solutionList = getMinimalCommonAncestorSolutions(nid1, nid2);
    ...
    private static class Solution implements Comparable<HashTreeWithIntArraySetsIsolated.Solution> {
        final HashTreeWithIntArraySetsIsolated.DistanceRecord nid1SolutionPart;
        final HashTreeWithIntArraySetsIsolated.DistanceRecord nid2SolutionPart;
        final int taxonomyDistance;

        public Solution(HashTreeWithIntArraySetsIsolated.DistanceRecord nid1SolutionPart, HashTreeWithIntArraySetsIsolated.DistanceRecord nid2SolutionPart) {
        ...
        @Override
        public int compareTo(HashTreeWithIntArraySetsIsolated.Solution o) {
    ...
    private static class DistanceRecord implements Comparable<HashTreeWithIntArraySetsIsolated.DistanceRecord> {
        final int childNid;
        ...
        boolean isSolution(HashTreeWithIntArraySetsIsolated.DistanceRecord another) {
        ...
        public boolean equals(Object o) {
            ...
            HashTreeWithIntArraySetsIsolated.DistanceRecord that = (HashTreeWithIntArraySetsIsolated.DistanceRecord) o;
        ...
        @Override
        public int compareTo(HashTreeWithIntArraySetsIsolated.DistanceRecord o) {
