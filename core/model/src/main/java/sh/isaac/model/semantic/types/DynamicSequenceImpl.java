...
/**
 * {@link DynamicSequenceImpl}.
 *
 * @author <a href="mailto:daniel.armbrust.list@gmail.com">Dan Armbrust</a>
 */
public class DynamicSequenceImpl
   ...
   /**
    * Instantiates a new dynamic sequence impl.
    *
    * @param data the data
    */
   protected DynamicSequenceImpl(byte[] data) {
      super(data);
   }
    ...
    * @param nid the nid
    */
   public DynamicSequenceImpl(int nid) {
      super();
    ...
    */
   protected DynamicSequenceImpl(byte[] data, int assemblageSequence, int columnNumber) {
