...
public class Observable_Str1_Str2_Nid3_Nid4_VersionImpl
   ...
   @Override
    ...
    public <V extends Version> V makeAnalog(int stampSequence) {
      Str1_Str2_Nid3_Nid4_VersionImpl newVersion = getOptionalStampedVersion().get().makeAnalog(stampSequence);
      Observable_Str1_Str2_Nid3_Nid4_VersionImpl newObservableVersion = new Observable_Str1_Str2_Nid3_Nid4_VersionImpl(newVersion, getChronology());
