 ...
 * @author kec
 */
public class StampPositionAdaptor extends XmlAdapter<StampPositionImpl, StampPosition> {

    @Override
    public StampPosition unmarshal(StampPositionImpl v) throws Exception {
        return v;
    }

    @Override
    public StampPositionImpl marshal(StampPosition v) throws Exception {
        if (v instanceof StampPositionImpl) {
            return (StampPositionImpl) v;
        }
