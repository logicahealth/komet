...
public class AndNode
    ...
    */
   public AndNode(LogicalExpressionImpl logicGraphVersion, AbstractLogicNode... children) {
    ...
    */
   public AndNode(LogicalExpressionImpl logicGraphVersion, ByteArrayDataBuffer dataInputStream) {
