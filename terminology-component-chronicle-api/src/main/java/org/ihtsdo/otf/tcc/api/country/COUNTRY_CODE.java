...
package org.ihtsdo.otf.tcc.api.country;

/**
 * Country codes derived from: http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#ZZ
 * @author kec
 */
public enum COUNTRY_CODE {
    ...
    LA("Lao People's Democratic Republic"), LB("Lebanon"), LC("Saint Lucia"), LI("Liechtenstein"), LK("Sri Lanka"),
    ...
    MH("Marshall Islands"), MK("Macedonia, the former Yugoslav Republic of"), ML("Mali"), MM("Myanmar"),
    ...
    PM("Saint Pierre and Miquelon"), PN("Pitcairn"), PR("Puerto Rico"), PS("Palestinian Territory, Occupied"),
    PT("Portugal"), PW("Palau"), PY("Paraguay"), QA("Qatar"), RE("Réunion"), RO("Romania"), RS("Serbia"),
    RU("Russian Federation"), RW("Rwanda"), SA("Saudi Arabia"), SB("Solomon Islands"), SC("Seychelles"), SD("Sudan"),
    ...
    ZW("Zimbabwe"), ZZ("Test Country");

    private String description;

    private COUNTRY_CODE(String description) {
