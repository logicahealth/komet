...
public class IsaacPreferencesImpl
    ...
    public static final IsaacPreferencesImpl preferencesImpl = new IsaacPreferencesImpl();
    public static final IsaacPreferencesWrapper preferencesWrapper = new IsaacPreferencesWrapper(preferencesImpl);
    ...
    private static void recursiveInit(IsaacPreferencesImpl preferences) {
        preferences.init();
        for (AbstractPreferences childPreferences : preferences.cachedChildren()) {
            recursiveInit((IsaacPreferencesImpl) childPreferences);
        }
    }
    //~--- methods -------------------------------------------------------------
