...
public class ClassifierProvider
   ...
   public TimedTask<ClassifierResults> classify() {
      return AggregateClassifyTask.get(this.stampCoordinate, this.logicCoordinate, editCoordinate, false);
   }
   
   @Override
   public TimedTask<ClassifierResults> classify(boolean cycleCheck) {
      return AggregateClassifyTask.get(this.stampCoordinate, this.logicCoordinate, editCoordinate, cycleCheck);
   }
