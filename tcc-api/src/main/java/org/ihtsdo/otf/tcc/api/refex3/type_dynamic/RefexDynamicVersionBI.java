 ...
 */
public interface RefexDynamicVersionBI<A extends RefexDynamicAnalogBI<A>> extends RefexVersionBI<A> {
    /**
     * @return The nid of the component that defines the columns of data used in
     *         this Refex, and provides a description for the purpose of this
     *         Refex linkage. See {@link #getRefexUsageDescription()} for a much
     *         more useful (but more expensive) convenience method.
     */
    int getRefexUsageDescriptorNid();

    /**
     * A convenience method that reads the concept referenced in
     * {@link #getColumnDescriptorNid()} and returns the actual column
