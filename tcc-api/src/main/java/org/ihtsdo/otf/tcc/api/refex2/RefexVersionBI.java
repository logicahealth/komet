...
public interface RefexVersionBI extends ComponentVersionBI, RefexChronicleBI
{
	 ...
	 */
	@Override
	RefexCAB makeBlueprint(ViewCoordinate viewCoordinate, IdDirective idDirective, RefexDirective refexDirective) throws IOException, InvalidCAB, ContradictionException;
