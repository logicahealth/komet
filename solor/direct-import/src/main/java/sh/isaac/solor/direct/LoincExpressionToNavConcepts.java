...
//                            logicalExpression);
            ...
            
            {
                ...
                addObservedByMethod(transaction, new ConceptProxy("Electrocardiographic procedure (procedure)", UUID.fromString("2dc7d2f4-1fc1-30d9-9d84-ac2202d98fb4")).getNid(), builderService, stamp);
...
//                addObservedByMethod(transaction, new ConceptProxy("Licensed practical nurse (occupation)", UUID.fromString("a10839d5-6433-3d1c-a57b-fc4a439fa1b8")).getNid(), builderService, stamp);
                ...
                addObservedByMethod(transaction, new ConceptProxy("Potassium ferrocyanide stain method", UUID.fromString("518afa3b-56be-35ff-a329-5da562b6d860")).getNid(), builderService, stamp);
