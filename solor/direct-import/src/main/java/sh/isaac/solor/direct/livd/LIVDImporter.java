...
public class LIVDImporter {
    ...
    public LIVDImporter(Transaction transaction, Semaphore writeSemaphore, int WRITE_PERMITS) {
    ...
    public void runImport(InputStream inputStream){
        ...
        Get.executor().submit(new LIVDAssemblageWriter(transaction, valuesToWrite, this.writeSemaphore));
