...
/**
 * TODO: This is a copy of the class by Dan. It is copied here temporarily. THe class depends on metadata,
 * and once we have metadata externally developed, the metadata project should no longer be required,
 * and the API and Model modules can eliminate the circular metadata dependencies and classes like this move
 * either to API or to Model.
 *
 * @author kec
 */
public class TempDirectWriteHelper {
    ...
    private int pathNid;
    private TempConverterUUID converterUUID;
    ...
    private TempLoadStats loadStats;
     ...
     */
    public TempDirectWriteHelper(Transaction transaction, int author, int module, int path, TempConverterUUID converterUUID, String terminologyName, boolean delayValidations)
    {
        ...
        this.loadStats = new TempLoadStats();
     ...
     */
    public TempLoadStats getLoadStats()
    {
        return loadStats;
    }
    ...
    public UUID linkToExistingAttributeTypeConcept(ConceptSpecification existingConstant, long time, StampFilter stampFilter)
    {
        ...
        Set<Integer> existingParents = lgs.get(0).get().getLogicalExpression().getParentConceptNids();
