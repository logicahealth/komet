...
public class TempDynamicTypeMap {
    ...
    public TempDynamicTypeMap(String typeURI, RDFNode exampleData, Function<String, UUID> uriToUUIDFunction, Consumer<Resource> conceptThatMustBeCreated)
    {
