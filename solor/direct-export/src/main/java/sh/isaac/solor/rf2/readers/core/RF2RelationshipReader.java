...
public class RF2RelationshipReader extends TimedTaskWithProgressTracker<List<String>> {
    ...
    public RF2RelationshipReader(List<Chronology> chronologies, Semaphore readSemaphore, Manifold manifold, String message) {
