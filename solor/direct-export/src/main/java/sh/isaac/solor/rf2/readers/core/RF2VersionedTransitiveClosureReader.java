...
public class RF2VersionedTransitiveClosureReader extends TimedTaskWithProgressTracker<List<String>> {
    ...
    public RF2VersionedTransitiveClosureReader(List<Chronology> chronologies, Semaphore readSemaphore, Manifold manifold, String message) {
