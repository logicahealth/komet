...
import static sh.isaac.solor.mojo.HoDirectImporter.ALLERGEN_ASSEMBLAGE;
import static sh.isaac.solor.mojo.HoDirectImporter.HDX_CCS_MULTI_1_ICD_MAP;
import static sh.isaac.solor.mojo.HoDirectImporter.HDX_CCS_MULTI_2_ICD_MAP;
import static sh.isaac.solor.mojo.HoDirectImporter.HDX_CCS_SINGLE_ICD_MAP;
import static sh.isaac.solor.mojo.HoDirectImporter.HDX_DEPRECATED;
import static sh.isaac.solor.mojo.HoDirectImporter.HDX_ICD10CM_MAP;
import static sh.isaac.solor.mojo.HoDirectImporter.HDX_ICD10PCS_MAP;
import static sh.isaac.solor.mojo.HoDirectImporter.HDX_ICF_MAP;
import static sh.isaac.solor.mojo.HoDirectImporter.HDX_ICPC_MAP;
import static sh.isaac.solor.mojo.HoDirectImporter.HDX_LEGACY_IS_A;
import static sh.isaac.solor.mojo.HoDirectImporter.HDX_MDC_MAP;
import static sh.isaac.solor.mojo.HoDirectImporter.HDX_MESH_MAP;
import static sh.isaac.solor.mojo.HoDirectImporter.HDX_RADLEX_MAP;
import static sh.isaac.solor.mojo.HoDirectImporter.HDX_RXCUI_MAP;
import static sh.isaac.solor.mojo.HoDirectImporter.HDX_SOLOR_EQUIVALENCE_ASSEMBLAGE;
import static sh.isaac.solor.mojo.HoDirectImporter.HUMAN_DX_MODULE;
import static sh.isaac.solor.mojo.HoDirectImporter.INEXACT_SNOMED_ASSEMBLAGE;
import static sh.isaac.solor.mojo.HoDirectImporter.IS_CATEGORY_ASSEMBLAGE;
import static sh.isaac.solor.mojo.HoDirectImporter.IS_DIAGNOSIS_ASSEMBLAGE;
import static sh.isaac.solor.mojo.HoDirectImporter.LEGACY_HUMAN_DX_ROOT_CONCEPT;
import static sh.isaac.solor.mojo.HoDirectImporter.REFID_ASSEMBLAGE;
import static sh.isaac.solor.mojo.HoDirectImporter.SNOMED_MAP_ASSEMBLAGE;
import static sh.isaac.solor.mojo.HoDirectImporter.HDX_ENTITY_ASSEMBLAGE;
import static sh.isaac.solor.mojo.HoDirectImporter.HDX_REVIEW_REQUIRED;
import static sh.isaac.solor.mojo.HoDirectImporter.HUMAN_DX_SOLOR_CONCEPT_ASSEMBLAGE;
import static sh.isaac.solor.mojo.HoDirectImporter.HUMAN_DX_SOLOR_DESCRIPTION_ASSEMBLAGE;
import static sh.isaac.solor.mojo.HoDirectImporter.INEXACT_RXCUI_ASSEMBLAGE;
import static sh.isaac.solor.mojo.HoDirectImporter.INEXACT_RXNORM_ASSOCIATION_TYPE;
import static sh.isaac.solor.mojo.HoDirectImporter.LEGACY_HUMAN_DX_MODULE;
import static sh.isaac.solor.mojo.HoDirectImporter.INEXACT_RXNORM_PRODUCT;
import static sh.isaac.solor.mojo.HoDirectImporter.RXNORM_PRODUCT;
...
//                    addDescription(hoRec, shortName, TermAux.REGULAR_NAME_DESCRIPTION_TYPE, conceptUuid, recordStamp);
    ...
    protected void buildConcept(UUID conceptUuid, String conceptName, int stamp, int legacyStamp, int inactiveLegacyStamp, int[] parentConceptNids, String[] hoRec) throws IllegalStateException, NoSuchElementException {
        ...
        if (!hoRec[DEPRECATED].isEmpty() && Boolean.parseBoolean(hoRec[DEPRECATED])) {
            ...
            ConceptVersion conceptVersion = conceptChronology.createMutableVersion(transaction, inactiveLegacyStamp);
