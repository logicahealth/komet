 ...
 * @author kec
 */
public class EmojiOneWrapper extends GlyphFont {
    public static final String FONT_NAME = "EmojiOne"; //$NON-NLS-1$
     ...
     */
    public EmojiOneWrapper() {
        this(EmojiOne.class.getResourceAsStream("emojione-svg.otf")); //$NON-NLS-1$
    }
     ...
     * @param url
     */
    public EmojiOneWrapper(String url){
        super(FONT_NAME, 14, url, true);
        for (EmojiOne emoji: EmojiOne.values()) {
            register(emoji.name(), emoji.unicode().charAt(0));
        }
    }
     ...
     * @param is
     */
    public EmojiOneWrapper(InputStream is){
