 ...
 * @author kec
 */
public class MaterialDesignIconWrapper extends GlyphFont {
    public static final String FONT_NAME = "Material design icons"; //$NON-NLS-1$
     ...
     */
    public MaterialDesignIconWrapper() {
        this(MaterialIcon.class.getResourceAsStream("MaterialIcons-Regular.ttf")); //$NON-NLS-1$
    }
     ...
     * @param url
     */
    public MaterialDesignIconWrapper(String url){
        super(FONT_NAME, 14, url, true);
        for (MaterialIcon item: MaterialIcon.values()) {
     ...
     * @param is
     */
    public MaterialDesignIconWrapper(InputStream is){
