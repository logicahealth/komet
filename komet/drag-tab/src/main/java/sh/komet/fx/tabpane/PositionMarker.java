...
public final class PositionMarker extends Group {
	...
	@SuppressWarnings("null")
	private static final CssMetaData<PositionMarker, Paint> FILL = new CssMetaData<PositionMarker, Paint>("-fx-fill", StyleConverter.getPaintConverter(), Color.rgb(0, 139, 255)) { //$NON-NLS-1$
