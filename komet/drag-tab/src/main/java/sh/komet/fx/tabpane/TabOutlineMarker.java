...
public final class TabOutlineMarker extends Group {
	...
	public void updateBounds( Bounds containerBounds,  Bounds referenceBounds, boolean before) {
		...
		pl.getPoints().addAll( // -----------------
                ...
                // -----------------
                // start
                0.0, Double.valueOf(_referenceBounds.getMaxY()),
	...
	@SuppressWarnings("null")
	private static final CssMetaData<TabOutlineMarker,  Paint> FILL = new CssMetaData<TabOutlineMarker,  Paint>("-fx-fill", StyleConverter.getPaintConverter(), Color.ORANGE) { //$NON-NLS-1$
