...
public class TextAreaBehavior extends TextInputControlBehavior<TextArea> {
    private TextAreaNoScrollerSkin skin;
    ...
    public TextAreaBehavior(final TextArea c) {
        ...
        textAreaInputMap.getMappings().addAll(
                ...
                keyMapping(UP,        e -> skin.moveCaret(TextInputControlSkin.TextUnit.LINE, TextInputControlSkin.Direction.UP,   false)),
                keyMapping(DOWN,      e -> skin.moveCaret(TextInputControlSkin.TextUnit.LINE, TextInputControlSkin.Direction.DOWN, false)),
                keyMapping(PAGE_UP,   e -> skin.moveCaret(TextInputControlSkin.TextUnit.PAGE, TextInputControlSkin.Direction.UP,   false)),
                keyMapping(PAGE_DOWN, e -> skin.moveCaret(TextInputControlSkin.TextUnit.PAGE, TextInputControlSkin.Direction.DOWN, false)),

                keyMapping(new KeyBinding(HOME).shift(),      e -> lineStart(true)),
                keyMapping(new KeyBinding(END).shift(),       e -> lineEnd(true)),
                keyMapping(new KeyBinding(UP).shift(),        e -> skin.moveCaret(TextInputControlSkin.TextUnit.LINE, TextInputControlSkin.Direction.UP,   true)),
                keyMapping(new KeyBinding(DOWN).shift(),      e -> skin.moveCaret(TextInputControlSkin.TextUnit.LINE, TextInputControlSkin.Direction.DOWN, true)),
                keyMapping(new KeyBinding(PAGE_UP).shift(),   e -> skin.moveCaret(TextInputControlSkin.TextUnit.PAGE, TextInputControlSkin.Direction.UP,   true)),
                keyMapping(new KeyBinding(PAGE_DOWN).shift(), e -> skin.moveCaret(TextInputControlSkin.TextUnit.PAGE, TextInputControlSkin.Direction.DOWN, true)),
        ...
        macOsInputMap.getMappings().addAll(
                ...
                keyMapping(new KeyBinding(UP).alt(),           e -> skin.moveCaret(TextInputControlSkin.TextUnit.PARAGRAPH, TextInputControlSkin.Direction.UP,   false)),
                keyMapping(new KeyBinding(DOWN).alt(),         e -> skin.moveCaret(TextInputControlSkin.TextUnit.PARAGRAPH, TextInputControlSkin.Direction.DOWN, false)),
                keyMapping(new KeyBinding(UP).alt().shift(),   e -> skin.moveCaret(TextInputControlSkin.TextUnit.PARAGRAPH, TextInputControlSkin.Direction.UP,   true)),
                keyMapping(new KeyBinding(DOWN).alt().shift(), e -> skin.moveCaret(TextInputControlSkin.TextUnit.PARAGRAPH, TextInputControlSkin.Direction.DOWN, true))
        );
        ...
        nonMacOsInputMap.getMappings().addAll(
                keyMapping(new KeyBinding(UP).ctrl(),           e -> skin.moveCaret(TextInputControlSkin.TextUnit.PARAGRAPH, TextInputControlSkin.Direction.UP,   false)),
                keyMapping(new KeyBinding(DOWN).ctrl(),         e -> skin.moveCaret(TextInputControlSkin.TextUnit.PARAGRAPH, TextInputControlSkin.Direction.DOWN, false)),
                keyMapping(new KeyBinding(UP).ctrl().shift(),   e -> skin.moveCaret(TextInputControlSkin.TextUnit.PARAGRAPH, TextInputControlSkin.Direction.UP,   true)),
                keyMapping(new KeyBinding(DOWN).ctrl().shift(), e -> skin.moveCaret(TextInputControlSkin.TextUnit.PARAGRAPH, TextInputControlSkin.Direction.DOWN, true))
        );
...
//                    skin.hideCaret();
    ...
    public void setTextAreaSkin(TextAreaNoScrollerSkin skin) {
        this.skin = skin;
    }
    ...
    private void lineStart(boolean select) {
        skin.moveCaret(TextInputControlSkin.TextUnit.LINE, TextInputControlSkin.Direction.BEGINNING, select);
    }

    private void lineEnd(boolean select) {
        skin.moveCaret(TextInputControlSkin.TextUnit.LINE, TextInputControlSkin.Direction.END, select);
    }
...
//                    displaySoftwareKeyboard(true);
    ...
    protected void mouseTripleClick(HitInfo hit) {
        // select the line
        skin.moveCaret(TextInputControlSkin.TextUnit.PARAGRAPH, TextInputControlSkin.Direction.BEGINNING, false);
        skin.moveCaret(TextInputControlSkin.TextUnit.PARAGRAPH, TextInputControlSkin.Direction.END, true);
    }
}