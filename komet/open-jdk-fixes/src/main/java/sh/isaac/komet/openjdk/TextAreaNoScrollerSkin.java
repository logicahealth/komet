 ...
 * @since 9
 */
public class TextAreaNoScrollerSkin extends TextInputControlSkin<TextArea> {
     ...
     */
    public TextAreaNoScrollerSkin(final TextArea control) {
        super(control);
    ...
    private class ContentView extends Region {
        ...
        @Override protected double computePrefWidth(double height) {
            if (computedPrefWidth < 0) {
                ...
                computedPrefWidth = Math.max(prefWidth, 0);
            }
        ...
        @Override protected double computePrefHeight(double width) {
            ...
            if (computedPrefHeight < 0) {
                ...
                computedPrefHeight = Math.max(prefHeight, 0);
            }
