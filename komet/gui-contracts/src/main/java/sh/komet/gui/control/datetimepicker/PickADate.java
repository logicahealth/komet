 ...
 * @since 2016-03-09
 */
public class PickADate extends DatePicker implements IFXValidatableControl {
     ...
     * {@inheritDoc}
     */
    public PickADate(LocalDate localDate) {
        super(localDate);
        initialize();
    }
    ...
    private void initialize() {
        ...
        final FakeFocusPickerTextField editorNode = new FakeFocusPickerTextField();
     ...
     */
    private StyleableBooleanProperty overLay = new SimpleStyleableBooleanProperty(PickADate.StyleableProperties.OVERLAY,
            PickADate.this,
            "overLay",
            false);
     ...
     */
    private StyleableObjectProperty<Paint> defaultColor = new SimpleStyleableObjectProperty<>(PickADate.StyleableProperties.DEFAULT_COLOR,
            PickADate.this,
            "defaultColor",
            Color.valueOf(
                    "#009688"));
    ...
    private static class StyleableProperties {
        private static final CssMetaData<PickADate, Paint> DEFAULT_COLOR =
                new CssMetaData<PickADate, Paint>("-jfx-default-color",
                        PaintConverter.getInstance(), Color.valueOf("#009688")) {
                    @Override
                    public boolean isSettable(PickADate control) {
                        return control.defaultColor == null || !control.defaultColor.isBound();
                    }

                    @Override
                    public StyleableProperty<Paint> getStyleableProperty(PickADate control) {
                        return control.defaultColorProperty();
                    }
                };

        private static final CssMetaData<PickADate, Boolean> OVERLAY =
                new CssMetaData<PickADate, Boolean>("-jfx-overlay",
                    ...
                    @Override
                    public StyleableBooleanProperty getStyleableProperty(PickADate control) {
    ...
    public static List<CssMetaData<? extends Styleable, ?>> getClassCssMetaData() {
        return PickADate.StyleableProperties.CHILD_STYLEABLES;
    }
