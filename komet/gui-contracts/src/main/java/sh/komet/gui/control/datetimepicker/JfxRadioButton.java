...
public class JfxRadioButton extends RadioButton {
     ...
     */
    private StyleableObjectProperty<Color> selectedColor = new SimpleStyleableObjectProperty<>(JfxRadioButton.StyleableProperties.SELECTED_COLOR,
            JfxRadioButton.this,
            "selectedColor",
            Color.valueOf(
                    "#0F9D58"));
    ...
    private StyleableObjectProperty<Color> unSelectedColor = new SimpleStyleableObjectProperty<>(
            JfxRadioButton.StyleableProperties.UNSELECTED_COLOR,
            JfxRadioButton.this,
            "unSelectedColor",
     ...
     */
    private StyleableBooleanProperty disableVisualFocus = new SimpleStyleableBooleanProperty(JfxRadioButton.StyleableProperties.DISABLE_VISUAL_FOCUS,
            JfxRadioButton.this,
            "disableVisualFocus",
            false);
    ...
    public static List<CssMetaData<? extends Styleable, ?>> getClassCssMetaData() {
        return JfxRadioButton.StyleableProperties.CHILD_STYLEABLES;
    }
}