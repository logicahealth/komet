 ...
 * @since 2017-03-01
 */
public class TimePicker extends ComboBoxBase<LocalTime> implements IFXValidatableControl {
     ...
     */
    private StyleableBooleanProperty overLay = new SimpleStyleableBooleanProperty(TimePicker.StyleableProperties.OVERLAY,
            TimePicker.this,
            "overLay",
            false);
     ...
     */
    private StyleableObjectProperty<Paint> defaultColor = new SimpleStyleableObjectProperty<>(TimePicker.StyleableProperties.DEFAULT_COLOR,
            TimePicker.this,
            "defaultColor",
            Color.valueOf(
                    "#009688"));
    ...
    private static class StyleableProperties {
        private static final CssMetaData<TimePicker, Paint> DEFAULT_COLOR =
                new CssMetaData<TimePicker, Paint>("-jfx-default-color",
                    ...
                    @Override
                    public StyleableProperty<Paint> getStyleableProperty(TimePicker control) {
                        return control.defaultColorProperty();
                    }
                };

        private static final CssMetaData<TimePicker, Boolean> OVERLAY =
                new CssMetaData<TimePicker, Boolean>("-jfx-overlay",
                    ...
                    @Override
                    public StyleableBooleanProperty getStyleableProperty(TimePicker control) {
    ...
    public static List<CssMetaData<? extends Styleable, ?>> getClassCssMetaData() {
        return TimePicker.StyleableProperties.CHILD_STYLEABLES;
    }
}
