 ...
 * @author kec
 */
public class TextAreaAutoSizeSkin extends TextInputControlSkin<TextArea, TextAreaBehaviourAutoSize> {
    ...
    private class ContentView extends Region {
            ...
            if (computedPrefWidth < 0) {
                ...
                for (Node node : paragraphNodes.getChildren()) {
                    ...
                    prefWidth = Math.max(prefWidth,
                            TextAreaUtils.computeTextWidth(paragraphNode.getFont(),
        ...
        protected double computePrefHeight(double width) {
            ...
            if (computedPrefHeight < 0) {
                ...
                for (Node node : paragraphNodes.getChildren()) {
                    Text paragraphNode = (Text)node;
                    prefHeight += TextAreaUtils.computeTextHeight(
    ...
    public TextAreaAutoSizeSkin(final TextArea textArea) {
        super(textArea, new TextAreaBehaviourAutoSize(textArea));
...
//        setManaged(false);
    ...
    public double computeBaselineOffset(double topInset, double rightInset, double bottomInset, double leftInset) {
        ...
        return TextAreaUtils.getAscent(getSkinnable().getFont(),firstParagraph.getBoundsType())
    ...
    private void updateFontMetrics() {
        Text firstParagraph = (Text)paragraphNodes.getChildren().get(0);
        lineHeight = TextAreaUtils.getLineHeight(getSkinnable().getFont(),firstParagraph.getBoundsType());
