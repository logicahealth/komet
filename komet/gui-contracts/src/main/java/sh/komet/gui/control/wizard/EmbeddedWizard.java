    ...
    public static class Builder{
        ...
        public void addWizardView(WizardView wizardView){
            try{
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource(wizardView.getWizardViewFXML()));
                newWizardPane.setId(wizardView.getWizardViewUUID().toString());
                newWizardPane.setContent(loader.load());
                this.wizardPanes.add(loader.getController());
