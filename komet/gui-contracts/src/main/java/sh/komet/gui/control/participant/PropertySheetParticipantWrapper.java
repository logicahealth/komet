 ...
 * @author kec
 */
public class PropertySheetParticipantWrapper implements PropertySheet.Item {
    private final SimpleObjectProperty<ParticipantImpl> wrappedProperty;
    private final String name;

    public PropertySheetParticipantWrapper(Manifold manifold, SimpleObjectProperty<ParticipantImpl> wrappedProperty) {
    ...
    public void setValue(Object value) {
        if (wrappedProperty.get() != value) {
            wrappedProperty.set((ParticipantImpl) value);
        }
     }
