...
public enum StyleClasses {
   ...
   COMPONENT_TEXT, VERSION_PANEL, HEADER_PANEL, HEADER_TEXT, ADD_BUTTON,
   ADD_SEMEME, STAMP_INDICATOR, VERSION_GRAPH_TOGGLE, ADD_TAB_MENU_BUTTON,
   MULTI_PARENT_TREE_NODE, TOP_GRID_PANE
   ;
