 ...
 */
public class MultiParentTreeItemImpl extends TreeItem<ConceptChronology>
      ...
      try {
         if (this.getValue() != null) {
            if (conceptDescriptionText == null || conceptDescriptionText.startsWith("no description for ")) {
               LatestVersion<String> latestDescriptionText = treeView.getManifold().getDescriptionText(nid);
               latestDescriptionText
                       .ifPresent((descriptionText) -> this.conceptDescriptionText = descriptionText)
