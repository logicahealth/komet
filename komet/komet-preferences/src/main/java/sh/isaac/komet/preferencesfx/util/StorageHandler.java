package sh.isaac.komet.preferencesfx.util;

import static sh.isaac.komet.preferencesfx.util.Constants.DEFAULT_DIVIDER_POSITION;
import static sh.isaac.komet.preferencesfx.util.Constants.DEFAULT_PREFERENCES_HEIGHT;
import static sh.isaac.komet.preferencesfx.util.Constants.DEFAULT_PREFERENCES_POS_X;
import static sh.isaac.komet.preferencesfx.util.Constants.DEFAULT_PREFERENCES_POS_Y;
import static sh.isaac.komet.preferencesfx.util.Constants.DEFAULT_PREFERENCES_WIDTH;
import static sh.isaac.komet.preferencesfx.util.Constants.DIVIDER_POSITION;
import static sh.isaac.komet.preferencesfx.util.Constants.SELECTED_CATEGORY;
import static sh.isaac.komet.preferencesfx.util.Constants.WINDOW_HEIGHT;
import static sh.isaac.komet.preferencesfx.util.Constants.WINDOW_POS_X;
import static sh.isaac.komet.preferencesfx.util.Constants.WINDOW_POS_Y;
import static sh.isaac.komet.preferencesfx.util.Constants.WINDOW_WIDTH;
...
public class StorageHandler {
  ...
  public StorageHandler(Class<?> saveClass) {
    preferences = FxGet.userNode(saveClass);
    gson = new Gson();
  }

  public StorageHandler(IsaacPreferences preferences) {
