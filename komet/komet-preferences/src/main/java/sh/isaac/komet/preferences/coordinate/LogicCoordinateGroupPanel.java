...
public class LogicCoordinateGroupPanel extends ParentPanel {
    ...
    public LogicCoordinateGroupPanel(IsaacPreferences preferencesNode, ViewProperties viewProperties, KometPreferencesController kpc) {
        super(preferencesNode, preferencesNode.get(GROUP_NAME, "Logic"), viewProperties, kpc);
        if (!initialized()) {
            ...
            new LogicCoordinateItemPanel(elProfileLogicCoordinate, EL_PROFILE_LOGIC_COORDINATE_KEY.getString(), childElProfilePreferences, viewProperties, kpc);
