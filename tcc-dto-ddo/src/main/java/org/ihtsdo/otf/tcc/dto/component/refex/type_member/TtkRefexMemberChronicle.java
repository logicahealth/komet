...
public class TtkRefexMemberChronicle extends TtkRefexAbstractMemberChronicle<TtkRefexRevision> {
    ...
    * <code>ERefsetMember</code> object, and contains the same values, field by field,
    * as this <code>ERefsetMember</code>.
    *
    ...
    *
    * @return a hash code value for this <code>ERefsetMember</code>.
    */
   @Override
   public int hashCode() {
