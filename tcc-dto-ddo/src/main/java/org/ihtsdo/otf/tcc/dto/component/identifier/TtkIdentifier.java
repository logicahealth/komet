...
public abstract class TtkIdentifier extends TtkRevision {
    ...
    * {@code EIdentifierVersion} object, and contains the same values, field by field,
    * as this {@code EIdentifierVersion}.
    *
   ...
   /**
    * Returns a hash code for this {@code EIdentifierVersion}.
    *
    * @return a hash code value for this {@code EIdentifierVersion}.
    */
   @Override
   public int hashCode() {
