...
public class TtkRefexUuidUuidMemberChronicle extends TtkRefexAbstractMemberChronicle<TtkRefexUuidUuidRevision> {
    ...
    * {@code ERefsetCidCidMember} object, and contains the same values, field by field,
    * as this {@code ERefsetCidCidMember}.
    *
   ...
   /**
    * Returns a hash code for this {@code ERefsetCidCidMember}.
    *
    * @return a hash code value for this {@code ERefsetCidCidMember}.
    */
   @Override
   public int hashCode() {
