...
public class TtkRefexUuidFloatMemberChronicle extends TtkRefexAbstractMemberChronicle<TtkRefexUuidFloatRevision> {
    ...
    * <code>ERefsetCidFloatMember</code> object, and contains the same values, field by field,
    * as this <code>ERefsetCidFloatMember</code>.
    *
    ...
    *
    * @return a hash code value for this <code>ERefsetCidFloatMember</code>.
    */
   @Override
   public int hashCode() {
