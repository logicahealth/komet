...
public class TtkRefexUuidIntMemberChronicle extends TtkRefexAbstractMemberChronicle<TtkRefexUuidIntRevision> {
    ...
    * {@code ERefsetCidIntMember} object, and contains the same values,
    * field by field, as this {@code ERefsetCidIntMember}.
    *
   ...
   /**
    * Returns a hash code for this {@code ERefsetCidIntMember}.
    *
    * @return  a hash code value for this {@code ERefsetCidIntMember}.
    */
   @Override
   public int hashCode() {
