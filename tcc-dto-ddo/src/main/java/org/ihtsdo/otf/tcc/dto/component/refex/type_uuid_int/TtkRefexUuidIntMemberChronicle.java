...
public class TtkRefexUuidIntMemberChronicle extends TtkRefexAbstractMemberChronicle<TtkRefexUuidIntRevision> {
    ...
    * <code>ERefsetCidIntMember</code> object, and contains the same values,
    * field by field, as this <code>ERefsetCidIntMember</code>.
    *
    ...
    *
    * @return  a hash code value for this <code>ERefsetCidIntMember</code>.
    */
   @Override
   public int hashCode() {
