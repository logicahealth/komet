...
public class TtkIdentifierUuid extends TtkIdentifier {
    ...
    * <code>EIdentifierVersionUuid</code> object, and contains the same values, field by field,
    * as this <code>EIdentifierVersionUuid</code>.
    *
    ...
    *
    * @return a hash code value for this <code>EIdentifierVersionUuid</code>.
    */
   @Override
   public int hashCode() {
