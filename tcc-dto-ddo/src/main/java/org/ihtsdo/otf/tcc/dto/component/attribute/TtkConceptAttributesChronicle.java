...
public class TtkConceptAttributesChronicle extends TtkComponentChronicle<TtkConceptAttributesRevision> {
    ...
    * <code>EConceptAttributes</code> object, and contains the same values, field by field,
    * as this <code>EConceptAttributes</code>.
    *
    ...
    *
    * @return a hash code value for this <code>EConceptAttributes</code>.
    */
   @Override
   public int hashCode() {
