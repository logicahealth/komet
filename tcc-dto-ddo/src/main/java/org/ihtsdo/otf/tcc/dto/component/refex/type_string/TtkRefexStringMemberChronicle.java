...
public class TtkRefexStringMemberChronicle extends TtkRefexAbstractMemberChronicle<TtkRefexStringRevision> {
   ...
   public TtkRefexStringMemberChronicle(RefexChronicleBI another) throws IOException {
    ...
    public <T extends StringSememeImpl> TtkRefexStringMemberChronicle(SememeChronologyImpl<StringSememeImpl> another) {
      super(another);
    ...
    * {@code ERefsetStrMember} object, and contains the same values, field by field,
    * as this {@code ERefsetStrMember}.
    *
   ...
   /**
    * Returns a hash code for this {@code ERefsetStrMember}.
    *
    * @return a hash code value for this {@code ERefsetStrMember}.
    */
   @Override
   public int hashCode() {
