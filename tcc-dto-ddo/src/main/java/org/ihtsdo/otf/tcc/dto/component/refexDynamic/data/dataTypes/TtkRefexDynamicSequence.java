...
/**
 * 
 * {@link TtkRefexDynamicSequence}
 *
 * @author <a href="mailto:daniel.armbrust.list@gmail.com">Dan Armbrust</a>
 */
public class TtkRefexDynamicSequence extends TtkRefexDynamicData
{
	public TtkRefexDynamicSequence(byte[] data)
	{
		super(data);
	}

	public TtkRefexDynamicSequence(int integer) throws PropertyVetoException
	{
		super();
