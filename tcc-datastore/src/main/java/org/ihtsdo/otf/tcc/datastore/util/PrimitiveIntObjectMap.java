...
/*
 * This class is based on a simple modification of the PrimitiveLongMap 
 * (Copyright 2005 JBoss Inc)
 * that is part of  drools 5.0 and licensed under the Apache License, Version 2.0.
 * 
 * This derivative work is also licensed under the Apache License, Version 2.0. 
 * 
 * Copyright 2009 IHTSDO
 * 
 *
 ...
 */
public class PrimitiveIntObjectMap implements Externalizable {
    /**
     *
     */
    ...
    public PrimitiveIntObjectMap(final int tableSize) {
        this( tableSize,
              8 );
    }
    ...
    public Object put(final int key,
    		Object value) {
        if ( key < 0 ) {
        ...
        if ( value == null ) {
            value = PrimitiveIntObjectMap.NULL;
        }

        final Page page = findPage( key );

        final Object oldValue = page.put( key,value );
    ...
    public Object remove(final int key) {
        ...
        final Object oldValue = page.put( key,null );
    ...
    public Object get(final int key) {
        ...
        if ( value == PrimitiveIntObjectMap.NULL ) {
            value = null;
        }
        return value;
    }
    ...
    public int getNext(int key) {
        final int currentPageId = key >> this.doubleShifts;
        final int nextPageId = (key+1) >> this.doubleShifts;
    ...
    private Page findPage(final int key) {
        // determine Page
        final int pageId = key >> this.doubleShifts;
        Page page;
    ...
    public static class Page
        ...
        public Object get(int key) {
            ...
            // determine table
            final int table = key >> this.shifts;

            // determine offset
            final int offset = table << this.shifts;

            // tables[table][slot]
            return this.tables[table][key - offset];
        }

        public Object put(int key, final Object newValue) {
            if ( this.tables == null ) {
                // initiate tree;
