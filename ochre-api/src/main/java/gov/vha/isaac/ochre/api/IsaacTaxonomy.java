...
public class IsaacTaxonomy {
    ...
    public void exportIBDF(Path exportFilePath) throws FileNotFoundException {
        ...
        int stampCoordinate = Get.commitService().getStampSequence(State.ACTIVE, exportTime,
        ...
        commitService.setComment(stampCoordinate, "Generated by maven from java sources");
        for (ConceptBuilder builder : conceptBuildersInInsertionOrder) {
            buildAndWrite(builder, stampCoordinate, conceptService, sememeService);
        }
        ...
        commitService.addAlias(stampCoordinate, stampAliasForPromotion, "promoted by maven");
