...
import java.lang.*;import java.lang.Object;import java.lang.String;import java.lang.StringBuilder;import java.lang.System;import java.lang.management.*;
import java.lang.management.GarbageCollectorMXBean;import java.lang.management.ManagementFactory;import java.lang.management.MemoryMXBean;import java.lang.management.MemoryPoolMXBean;import java.lang.management.MemoryUsage;import java.util.Formatter;
...
public class MemoryUtil {
    ...
    public static String getHeapPercentUse() {
        ...
        double percentUsed = 100.0d *  usage.getUsed() / usage.getMax();
        double sizeUsedInGB = 1.0d * usage.getUsed()/1000000000;
        StringBuilder sb = new StringBuilder();
        Formatter formatter = new Formatter(sb, Locale.US);
        formatter.format(" Heap used: %1$,3.2f GB (%2$,3.1f%%)", sizeUsedInGB, percentUsed);
        return sb.toString();
