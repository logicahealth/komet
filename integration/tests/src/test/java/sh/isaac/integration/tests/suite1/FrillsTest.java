...
public class FrillsTest {
	...
	public void testChildren() {
		...
		Assert.assertEquals(Frills.getAllChildrenOfConcept(MetaData.SOLOR_CONTENT_METADATA____SOLOR.getNid(), true, true, null).size(), 6);
		Assert.assertEquals(Frills.getAllChildrenOfConcept(MetaData.SOLOR_CONTENT_METADATA____SOLOR.getNid(), false, true, null).size(), 6);
		Assert.assertEquals(Frills.getAllChildrenOfConcept(MetaData.SOLOR_CONTENT_METADATA____SOLOR.getNid(), true, false, null).size(), 6);
		Assert.assertEquals(Frills.getAllChildrenOfConcept(MetaData.SOLOR_CONTENT_METADATA____SOLOR.getNid(), false, false, null).size(), 6);
