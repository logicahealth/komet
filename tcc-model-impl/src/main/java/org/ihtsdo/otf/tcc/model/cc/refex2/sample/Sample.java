 ...
 */
package org.ihtsdo.otf.tcc.model.cc.refex2.sample;
...
import org.ihtsdo.otf.tcc.model.cc.refex2.data.dataTypes.RefexBoolean;
import org.ihtsdo.otf.tcc.model.cc.refex2.data.dataTypes.RefexString;
...
public class Sample {
    public Sample() throws IOException
    {
        ...
        //Cast is to pretend we get back a refex2 reather than a refex (other code hasn't yet been updated)
