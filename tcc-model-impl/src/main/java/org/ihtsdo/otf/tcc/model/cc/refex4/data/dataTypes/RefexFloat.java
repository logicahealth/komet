...
public class RefexFloat extends RefexData implements RefexFloatBI {
	...
	/**
	 * @see org.ihtsdo.otf.tcc.api.refex4.data.dataTypes.RefexFloatBI#getDataFloat()
	 */
	@Override
	...
	/**
	 * @see org.ihtsdo.otf.tcc.api.refex4.data.dataTypes.RefexFloatBI#getDataFloatProperty()
	 */
	@Override
