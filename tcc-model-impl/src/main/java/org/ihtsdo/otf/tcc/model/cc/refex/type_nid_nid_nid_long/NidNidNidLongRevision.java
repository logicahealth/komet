...
public class NidNidNidLongRevision
   ...
   public NidNidNidLongRevision(DataInputStream input,
                                 NidNidNidLongMember primoridalMember) throws IOException {
   ...
   @Override
   public Collection<NidNidNidLongMemberVersion> getVersions() {
