package org.ihtsdo.otf.tcc.chronicle.cc.refex.cid;

import org.ihtsdo.otf.tcc.chronicle.cc.refex.type_nid.NidMember;
import org.ihtsdo.otf.tcc.chronicle.cc.refex.type_nid.NidRevision;
...
public class CidMemberTest {

    private NidMember testObj1;
    private NidMember testObj2;
    private NidMember testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<NidMember> coll = new java.util.HashSet<>();
        coll.add(testObj1);
    ...
    private NidMember makeTestObject1() {
        
        // Create an object to test... 
        NidMember obj = new NidMember();
        obj.setC1Nid(1);
        obj.revisions = new RevisionSet(1);
        NidRevision rev = new NidRevision(); 
    ...
    private NidMember makeTestObject2() {
