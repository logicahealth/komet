...
public class RelationshipImportDTO extends BaseImportDTO
{
	...
	private String newTargetCode;
	private String oldTargetCode;

	public RelationshipImportDTO(String action, String typeName, String oldTargetCode, String newTargetCode, boolean active)
	{
		super(action, active);
