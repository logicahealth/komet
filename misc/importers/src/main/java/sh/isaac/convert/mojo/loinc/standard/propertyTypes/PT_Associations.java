...
package sh.isaac.convert.mojo.loinc.standard.propertyTypes;

import sh.isaac.convert.mojo.loinc.LOINCConstants;
...
/**
 * The Class PT_Associations.
 *
 * @author Daniel Armbrust
 */
public class PT_Associations
        extends BPT_Associations {
   /**
   ...
   public PT_Associations() {
      ...
      addProperty(new PropertyAssociation(this,
            ...
            "Map To",
            null,
            "Associations from the LOINC 'Map To' table",
            false));
   }
}
