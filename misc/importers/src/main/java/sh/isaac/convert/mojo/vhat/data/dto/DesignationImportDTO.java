...
public class DesignationImportDTO extends CodedImportDTO
{
	...
	public DesignationImportDTO(String action, String typeName, String code, String valueOld, String valueNew, Long vuid, String moveFromConceptCode,
			boolean active)
	{
