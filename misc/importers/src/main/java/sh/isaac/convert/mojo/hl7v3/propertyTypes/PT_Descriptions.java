...
public class PT_Descriptions extends BPT_Descriptions
{
	public PT_Descriptions()
	{
		...
		addProperty("name", FULLY_QUALIFIED_NAME);		// this should be the FSN, unless missing, then work down the synonym hierarchy
		addProperty("print name", SYNONYM);
		addProperty("code", FULLY_QUALIFIED_NAME);
		addProperty("title", SYNONYM);
		addProperty("documentation", DEFINITION);
		addProperty("description", DEFINITION);
	}
}
